...
The above detraction does not apply to NixOS as an operating system. So, why do I use a regular distribution and not NixOS? The long and the short of it is that I do not have a personal usecase for reproducible builds. I am not installing large systems on new hardware regularly, and most situations where I am likely to install a new system on these days are systems where I will explicitly prioritize leanness and minimalism over a 900MB NixOS install.
